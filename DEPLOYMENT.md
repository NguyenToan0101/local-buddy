...
Buddy verification no longer starts a Python verification service. After a buddy uploads
the required files and saves the profile, Spring Boot marks the profile
`PROCESSING` and automatically verifies it after 10 minutes.
