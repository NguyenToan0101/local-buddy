...
import { Camera, User, Sparkles, Shield, Clock, FileText, Upload, CheckCircle2, Globe, Heart } from 'lucide-react';
                    ...
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div
                          ...
                          className={`group relative h-52 rounded-[40px] border-4 border-dashed transition-all flex flex-col items-center justify-center cursor-pointer ${passportFront ? 'border-accent-green bg-accent-green/5' : 'border-gray-100 hover:border-primary/20 bg-surface-dark hover:bg-primary/5'
                            }`}
                        >
                          <input
                            type="file"
                        ...
                        <div
                          ...
                          className={`group relative h-52 rounded-[40px] border-4 border-dashed transition-all flex flex-col items-center justify-center cursor-pointer ${passportBack ? 'border-accent-green bg-accent-green/5' : 'border-gray-100 hover:border-primary/20 bg-surface-dark hover:bg-primary/5'
                            }`}
                        >
                          <input
                            type="file"
