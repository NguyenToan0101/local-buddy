...
const LiveExperience: React.FC = () => {
  ...
  const confirmSOS = () => {
    setSosSent(true);
    // Real SOS logic integration here
  };
      ...
      <main className="pt-6 pb-20 px-4 sm:px-6 lg:px-16 max-w-5xl mx-auto space-y-12">
        ...
        <section className="space-y-6 text-center">
           <div className="space-y-2">
              <h1 className="text-5xl font-black text-secondary tracking-tighter">Your Experience is Live</h1>
              <p className="text-secondary/40 font-bold text-lg italic">Stay safe and enjoy the local life.</p>
           </div>
        </section>
           ...
           <div className="flex items-center gap-6">
              <div className="relative">
                 <div className="w-24 h-24 rounded-[32px] overflow-hidden shadow-2xl ring-4 ring-primary/5">
                    <img src={booking?.buddyAvatar || "https://i.pravatar.cc/150?u=12"} alt="Buddy" className="w-full h-full object-cover" />
                 </div>
                 <div className="absolute -right-1 -bottom-1 w-6 h-6 bg-green-500 rounded-full border-4 border-white shadow-lg"></div>
              </div>
              <div className="space-y-1 text-center md:text-left">
                 <h2 className="text-2xl font-black text-secondary tracking-tight">{booking?.buddyName || "Local Buddy"}</h2>
                 <div className="flex items-center justify-center md:justify-start gap-2 text-primary font-bold text-xs uppercase tracking-widest">
                    <ShieldCheck size={14} strokeWidth={3} /> Verified Local Buddy
                 </div>
              </div>
           </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
           ...
           <div className="bg-white rounded-[56px] p-10 md:p-12 shadow-premium border border-gray-50 flex flex-col gap-10">
              ...
              <div className="space-y-12 relative before:absolute before:left-[7px] before:top-2 before:bottom-2 before:w-[2px] before:bg-primary/10 before:border-l-2 RAD_border-dashed before:border-primary/20">
                 {/* Meeting Point */}
        ...
        <section className="bg-red-50/30 rounded-[64px] p-12 border border-red-100/50 space-y-8 animate-in slide-in-from-bottom-10 duration-1000">
           <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                 <h4 className="text-2xl font-black text-red-600 tracking-tight uppercase italic leading-none">Safety Controls</h4>
                 <p className="text-[10px] font-bold text-red-400">Use these buttons only in case of immediate danger or urgent assistance needed.</p>
              </div>
           </div>
