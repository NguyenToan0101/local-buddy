          ...
          <div className="space-y-8">
            {otpRequired ? (
              <form onSubmit={handleVerifyOtp} className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                {/* Security Header */}
                <div className="flex flex-col items-center justify-center text-center space-y-4 p-2 bg-[#F9FAFB] rounded-3xl border border-gray-100/50">
                  <div className="w-16 h-16 bg-[#FF7E4B]/10 text-[#FF7E4B] rounded-2xl flex items-center justify-center shadow-inner relative mt-2">
                    <div className="absolute inset-0 bg-[#FF7E4B]/5 rounded-2xl animate-ping opacity-30"></div>
                    <Lock size={28} className="relative z-10 animate-pulse" />
                  </div>
                  <div className="space-y-1 pb-2">
                    <h3 className="text-xl font-black text-[#1A1A1A] tracking-tight">Verification Check</h3>
                    <p className="text-[10px] font-black text-[#9CA3AF] uppercase tracking-[0.2em] leading-relaxed">
                ...
                <div className="space-y-4">
                  <p className="text-sm font-semibold text-[#4B5563] ml-1 leading-relaxed text-center">
                    We sent a 6-digit verification code to <br/>
                    <span className="text-[#FF7E4B] font-bold text-base">{email}</span>.
                  </p>
                ...
                <div className="space-y-4">
                  <Button 
                    ...
                    className="w-full bg-[#FF7E4B] hover:bg-[#FF6B35] text-white py-4.5 text-lg font-bold rounded-2xl shadow-[0_10px_20px_rgba(255,126,75,0.2)] transition-all hover:scale-[1.02] active:scale-95 border-none mt-2 flex items-center justify-center gap-2"
                  >
                    {verifyingOtp ? 'Verifying...' : 'Confirm & Continue'}
                  </Button>
                  ...
                  <div className="flex flex-col items-center gap-2 pt-2">
                    <button
                      ...
                      className="text-xs font-bold text-[#FF7E4B] hover:underline bg-transparent border-none outline-none"
                    >
                    ...
                    <button
                      ...
                      className="text-xs font-bold text-[#9CA3AF] hover:text-[#1A1A1A] transition-colors uppercase tracking-widest mt-2 hover:underline"
                    >
